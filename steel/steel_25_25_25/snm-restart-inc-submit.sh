...
module load openmpi
mpirun -np $SLURM_NTASKS singularity exec --bind ${BIND_PATH}:${BIND_PATH} frensie_hpc.simg python restart_and_inc_num_histories.py --threads=$SLURM_CPUS_PER_TASK --num_extra_particles=500000000000 --rendezvous_file="snm_rendezvous_11.xml"
